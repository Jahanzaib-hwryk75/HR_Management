...
<h4 class="card-title my-2">Positional Information</h4>
		...
		<div class="col-md-4 col-12">
			<div role="group" class="form-group" id="__BVID__1890"><label for="email" class="d-block" id="__BVID__1890__BV_label_">Duty Type</label>
				<div><input id="email" type="email" class="form-control">
				</div>
			</div>
		</div>
...
<div class="row">
		<div class="col-md-4 col-12">
			<div role="group" class="form-group" id="__BVID__1886"><label for="username" class="d-block" id="__BVID__1886__BV_label_">Hire Date</label>
				<div><input id="username" type="text" class="form-control">
				</div>
			</div>
		</div>
		<div class="col-md-4 col-12">
			<div role="group" class="form-group" id="__BVID__1888"><label for="full-name" class="d-block" id="__BVID__1888__BV_label_">Termination Date</label>
				<div><input id="full-name" type="text" class="form-control">
				</div>
			</div>
		</div>
...
<div class="row">
		...
		<div class="col-md-4 col-12">
			<div role="group" class="form-group" id="__BVID__1890"><label for="email" class="d-block" id="__BVID__1890__BV_label_"></label>
				<div>
				</div>
			</div>
		</div>
