        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="{{ url('/admin/updatecountry/'.$editcountry->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-8 offset-2">
                                        ...
                                        <input type="text" class="form-control" value="{{$editcountry->couuntryname ?? ''}}" id="couuntryname" name="couuntryname" placeholder="Enter Country" required />
                                        @error('couuntryname')
