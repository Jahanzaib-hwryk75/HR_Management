        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="{{ url('/admin/addleavetype')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-8 offset-2">
                                        ...
                                        <input type="text" class="form-control" id="countryname" name="countryname" value="{{$users->fullname ?? ''}}" placeholder="Enter Country Name" required />
                                        @error('countryname')
